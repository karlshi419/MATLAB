...
pcolor(xxx1,yyy1,pic_RCA_Trad);
shading interp;
colorbar
xlabel('Area');
ylabel('Ts');
title('RCA Traditional Scenario');
hold on
...
figure(3)
%surf(xxx2,yyy2,pic_CSA_2);
pcolor(xxx1,yyy1,pic_RCA_New);
shading interp;
colorbar
xlabel('Area');
ylabel('Ts');
title('RCA Overclocking Scenario');
...
figure(4)
%surf(xxx2,yyy2,pic_CSA_2);
pcolor(xxx4,yyy4,pic_CSA_3stage);
shading interp;
colorbar
xlabel('Area');
ylabel('Ts');
